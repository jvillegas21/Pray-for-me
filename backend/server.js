...
// Database connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/prayer_community', {
...
io.on('connection', (socket) => {
  ...
  socket.on('prayer-update', (data) => {
    socket.to(data.locationRoom).emit('prayer-updated', data);
  });
